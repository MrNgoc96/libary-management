...
public class SearchBookAction extends BaseAction {
    ...
    @Override
    @Action(value = "search-book", results = {@Result(name = "success", location = "/views/book/list-book.jsp")})
    ...
    public String execute() throws Exception {
        ...
        SearchResult<BookDTO> searchResult = bookService.searchBook(key, typeSearch, page);

        bookList = searchResult.getResults();
        ...
        addActionMessage(getText("book.searchResult", info));
